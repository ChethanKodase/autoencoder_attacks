...
def jacobian_regularized_loss_sigularity_search(model_reg, batch_x, alpha, no_samples, deg_poly,  latent_dim, points, ae_perturbed_embeds, device, guidanceTerm):

    nodes_subsample_np = sampleLegendreNodes(no_samples, latent_dim, points, deg_poly)
    #print('nodes_subsample_np', nodes_subsample_np.shape)
    nodes_subsample_np = ae_perturbed_embeds
    nodes_subsample = torch.FloatTensor(nodes_subsample_np).to(device)
    #print('nodes_subsample_np again', nodes_subsample_np.shape)
